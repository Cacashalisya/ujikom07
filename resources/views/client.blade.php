                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="client_box">
                                 <div class="left_main">
                                    <div class="image_6"><img src="images/raffi2.jpg" width="120px"></div>
                                 </div>
                                 <div class="right_main">
                                    <h6 class="magna_text">Muhammad Raffi</h6>
                                    <p class="consectetur_text">Consectetur adipiscing</p>
                                    <div class="quote_icon"></div>
                                 </div>
                                 <p class="ipsum_text">Perjalanan kami dengan SHA.Trip adalah pengalaman yang luar biasa. Mereka benar-benar memenuhi harapan kami dan memberikan layanan yang luar biasa dari awal hingga akhir perjalanan. </p>
                              </div>
                           </div>
                        </div>
                     </div>
